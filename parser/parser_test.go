...
You will love it.`)
	...
	is.Equal(greetInputObject.Fields[0].Type.TypeID, "github.com/nathan-isaac/oto/testdata/services.Page")
	is.Equal(greetInputObject.Fields[0].Type.IsObject, true)
	is.Equal(greetInputObject.Fields[0].Type.Multiple, false)
	is.Equal(greetInputObject.Fields[0].Type.Package, "github.com/nathan-isaac/oto/testdata/services")
	...
	is.Equal(greetOutputObject.Fields[0].Type.TypeID, "github.com/nathan-isaac/oto/parser/testdata/services/pleasantries.Greeting")
	...
	for i := range def.Objects {
		...
		case "Page":
			is.Equal(def.Objects[i].TypeID, "github.com/nathan-isaac/oto/testdata/services.Page")
